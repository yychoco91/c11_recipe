                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <i class="fa fa-shopping-basket"></i>&nbsp;&nbsp; <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Ingredient
                            Suggestions</a>
                        </h4>
                    </div>
                ...
                <div class="col-sm-12">
                    <div class="jumbotron text-center ">
                        ...
                        <form class="form-inline">
                            ...
                            <button type="button" class="btn btn-danger" onclick="getValue()">Go</button>
